...
#include "PSDtoUnrealInteractiveTool.generated.h"


/**
 * Builder for UPSDtoUnrealInteractiveTool
 */
UCLASS()
class PSDTOUNREAL_API UPSDtoUnrealInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UPSDtoUnrealInteractiveTool
 */
UCLASS(Transient)
class PSDTOUNREAL_API UPSDtoUnrealInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UPSDtoUnrealInteractiveToolProperties();
...
/**
 * UPSDtoUnrealInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class PSDTOUNREAL_API UPSDtoUnrealInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UPSDtoUnrealInteractiveToolProperties> Properties;
