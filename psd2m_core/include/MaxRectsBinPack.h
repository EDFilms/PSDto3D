//---------- ----------
// Original library from https://github.com/juj/RectangleBinPack
// Modified by Michaelson Britt, August 2019
//---------- ----------
//inlined header Rect.h, see below for MaxRectsBinPack.h
/** @file Rect.h
...
//using namespace std;
//inline int max( int a, int b ) { return (a>=b? a:b); } // TODO: Delete this, already declared as a macro
//inline int min( int a, int b ) { return (a<=b? a:b); } // TODO: Delete this, already declared as a macro
...
/** @file MaxRectsBinPack.h
	...
	This work is released to Public Domain, do whatever you want with it.
*/
//#pragma once //not needed with inlined header above

#include <vector>

// #include "Rect.h" //inlined header above
...
public:
	...
	Rect Insert(int width, int height, ID id, FreeRectChoiceHeuristic method);
