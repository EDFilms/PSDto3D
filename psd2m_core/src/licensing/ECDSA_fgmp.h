...
#define sz_prealloc 10

typedef struct mp_int {
    mp_size sz;
    mp_limb p_prealloc[sz_prealloc];
    mp_limb *p;
    short sn;
} MP_INT;
...
void mpz_init_set PROTO((MP_INT *s, const MP_INT *t));
...
void mpz_set PROTO((MP_INT *y, const MP_INT *x));
...
int mpz_cmp PROTO((const MP_INT *x, const MP_INT *y));
void mpz_mul PROTO((MP_INT *ww, const MP_INT *u, const MP_INT *v));
...
void mpz_add PROTO((MP_INT *zz, const MP_INT *x,const MP_INT *y));
//void mpz_add_ui PROTO((MP_INT *x,MP_INT *y, unsigned long n));
//void mpz_mul_ui PROTO((MP_INT *x,MP_INT *y, unsigned long n));
void mpz_sub PROTO((MP_INT *z, const MP_INT *x, const MP_INT *y));
//void mpz_sub_ui PROTO((MP_INT *x,MP_INT *y, unsigned long n));
void mpz_div PROTO((MP_INT *q, const MP_INT *x, const MP_INT *y));
//void mpz_mdiv PROTO((MP_INT *q, MP_INT *x, MP_INT *y));
//void mpz_mod PROTO((MP_INT *r, const MP_INT *x, const MP_INT *y));
//void mpz_divmod PROTO((MP_INT *q, MP_INT *r, MP_INT *x, MP_INT *y));
void mpz_mmod PROTO((MP_INT *r, const MP_INT *x, const MP_INT *y));
...
unsigned int mpz_sizeinbase PROTO((const MP_INT *x, int base));
char *mpz_get_str PROTO((char *s,  int base, const MP_INT *x));
int mpz_set_str PROTO((MP_INT *x, const char *s, int base));
...
void mpz_neg PROTO((MP_INT *, const MP_INT *));
...
int mpz_cmp_si PROTO((const MP_INT *, long));
void mpz_and PROTO((MP_INT *, const MP_INT *, const MP_INT *));
