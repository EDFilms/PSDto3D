...
function onLoaded() {
    ...
    // Manage the theme association to the extension
...
function updateThemeWithAppSkinInfo(appSkinInfo) {
	...
	if(appName == "PHXS" || appName == "PPRO" || appName == "PRLD") {
	    ...
	    addRule(styleId, "input[type=text]:focus", "background-color: " + inputBackgroundColor) + ";";
...
//-----------------------------------------------------------------------------------------------------------------
//
// Link script and functionalities region
//
//-----------------------------------------------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------------------------------------------
function onClickButtonRun(ppid, action) {
    if(ppid == "FLPR"){
