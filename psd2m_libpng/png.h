...
typedef int (*ProgressCallback)(png_voidp progress_param, float progress_val);  // Michaelson Britt added 27 Sep 2021; return 1 to cancel, 0 to continue

/* Write the image data */
PNG_EXPORT(60, void, png_write_image, (png_structrp png_ptr, png_bytepp image, ProgressCallback, png_voidp)); // Michaelson Britt added 24 Jul 2022
...
PNG_EXPORT(179, void, png_write_png, (png_structrp png_ptr, png_inforp info_ptr,
    int transforms, png_voidp params, ProgressCallback progress_callback, png_voidp progress_param));  // Michaelson Britt edited 27 Sep 2021
#endif
#endif
