...
devenv ..\projects\PSDto3D.sln /clean RelWithDebInfo_FBX /project psd2m_core
devenv ..\projects\PSDto3D.sln /clean RelWithDebInfo_FBX /project psd2m_fbx
devenv ..\projects\PSDto3D.sln /rebuild RelWithDebInfo_FBX /project psd2m_core
...
copy "..\psd2m_core\icons\PSD to 3D Icons.ico" "..\builds\installer\stage_full\fbx\icons\PSD to 3D Icons.ico"
...
copy ..\psd2m_core\conf\language_english.ini ..\builds\installer\stage_full\fbx\conf\english\language.ini
copy ..\psd2m_core\conf\language_french.ini ..\builds\installer\stage_full\fbx\conf\french\language.ini
